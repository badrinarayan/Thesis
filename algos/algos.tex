...
for the more general complex case using these results. We then provide a
...
semidefinite relaxations, we instead describe how we can use a discretization
...
associated with the line spectral atomic set $\mathcal{A} = \{a_{f,\phi} | f \in
[0, 1], \phi \in [0, 1]\}$. This provides an alternative route via the theory of
positive polynomials to derive the SDP characterization we already derived in
section~\ref{sub:general_trigonometric_moments}.
