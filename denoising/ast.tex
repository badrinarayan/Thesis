...
In this chapter, we defined atomic norms and the use of atomic norm penalty to denoise using AST~\eqref{AST} which may be thought of as a finite dimensional version of Lasso. We discussed how the regularization parameter may be chosen for AST.  We established a universal convergence rate which holds for all atomic sets and all signals and saw general conditions under which a fast rate is possible. In the following chapters, we will use this framework and apply to the problems of line spectral estimation and system identification.
