...
\gdef\@committee{
  ...
  \hspace*{1cm}Barry D.~Van Veen, Electrical and Computer Engineering\\
...
%-----------------------------------------------------------------------------
	...
	The dissertation is \textbf{not yet} approved by the following members of the Final Oral Committee:\\
	  \@committee
  \end{titlepage}
