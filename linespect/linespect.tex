...
the presence of noise can be thought of as a sparse approximation problem. The
regularization parameter for the strongest guarantee in Theorem
\ref{cor:expected-mse} is given in terms of the expected dual norm of the noise
and can be explicitly computed for many noise models. For example, when the
